...
function formatCepa ( d ) {
    ...
    return '<table cellpadding="25" cellspacing="0" border="0" style="padding-left:250px;">'+
		...
		'</tr>'+
        '<tr>'+
            '<td colspan="4"><button type="button" class="info btn btn-info btn-simple" data-toggle="modal" data-target="#modalInfoCepa" rel="tooltip" data-placement="bottom" title="Ver"><i class="material-icons">zoom_in</i><div class="ripple-container"></div></button><button type="button" class="editar btn btn-warning btn-simple" rel="tooltip" data-placement="bottom" title="Editar"><i class="material-icons">edit</i><div class="ripple-container"></div></button><button type="button" class="eliminar btn btn-danger btn-simple" rel="tooltip" data-placement="bottom" title="Eliminar"><i class="material-icons">close</i></button><button type="button" id="medios_selectivos" class="medios_selectivos btn btn-default btn-simple" rel="tooltip" data-placement="bottom" title="Medios Selectivos"><i class="material-icons">group_work</i><div class="ripple-container"></div></button><button type="button" id="identificacion_molecular" class="identificacion_molecular btn btn-default btn-simple" rel="tooltip" data-placement="bottom" title="Identificación Molecular"><i class="material-icons">find_in_page</i><div class="ripple-container"></div></button><button type="button" id="caracterizacion_fisiologica" class="caracterizacion_fisiologica btn btn-default btn-simple" rel="tooltip" data-placement="bottom" title="Caracterización Fisiológica"><i class="material-icons">assignment</i><div class="ripple-container"></div></button></td>'+
        '</tr>'+
    '</table>';
}
